...
class TagControllerTest extends WebTestCase
{
    ...
    public function testCreateTagIsSuccessful(): void
    {
        ...
        $this->assertSelectorTextContains('html', 'L\'étiquette a été créée');
    }
    ...
    public function testEditTagIsSuccessful(): void
    {
        ...
        $this->assertSelectorTextContains('.toast.alert-success', 'L\'étiquette a été mise à jour');
    }
    ...
    public function testDeleteTagIsSuccessful(): void
    {
        ...
        $this->assertResponseIsSuccessful();
        $this->assertSelectorTextContains('.toast.alert-warning', 'L\'étiquette a été supprimée');
    }
