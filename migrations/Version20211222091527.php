...
final class Version20211222091527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE charge (id INT AUTO_INCREMENT NOT NULL, eval_budget_person_id INT DEFAULT NULL, type SMALLINT NOT NULL, amount DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_556BA434338AD0BA (eval_budget_person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE debt (id INT AUTO_INCREMENT NOT NULL, eval_budget_person_id INT DEFAULT NULL, type SMALLINT NOT NULL, amount DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_DBBF0A83338AD0BA (eval_budget_person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE init_resource (id INT AUTO_INCREMENT NOT NULL, init_eval_person_id INT NOT NULL, type SMALLINT NOT NULL, amount DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_E71201A5260F0B1C (init_eval_person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, eval_budget_person_id INT DEFAULT NULL, end_date DATE DEFAULT NULL, type SMALLINT NOT NULL, amount DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_BC91F416338AD0BA (eval_budget_person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE eval_budget_person CHANGE charges charge SMALLINT DEFAULT NULL, CHANGE debts debt SMALLINT DEFAULT NULL, CHANGE resources resource SMALLINT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE init_resource');
