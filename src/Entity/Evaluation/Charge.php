...
use App\Repository\Evaluation\EvalPersonChargeRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=EvalPersonChargeRepository::class)
 */
class Charge extends AbstractFinance
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=EvalBudgetPerson::class, inversedBy="charges")
     */
