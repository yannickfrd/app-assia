...
use App\Repository\Evaluation\EvalBudgetDebtRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=EvalBudgetDebtRepository::class)
 */
class EvalBudgetDebt extends AbstractFinance
{
    public const DEBTS = [
    ...
    /**
     * @ORM\ManyToOne(targetEntity=EvalBudgetPerson::class, inversedBy="evalBudgetDebts")
     */
