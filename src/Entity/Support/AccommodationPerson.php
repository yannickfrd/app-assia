...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Support\AccommodationPersonRepository")
...
class AccommodationPerson
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Support\AccommodationGroup", inversedBy="accommodationPeople")
     */
    private $accommodationGroup;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\People\Person", inversedBy="accommodationPeople")
